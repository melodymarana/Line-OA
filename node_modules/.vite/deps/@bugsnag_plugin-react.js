          ...
          _proto2.render = function render() {
            ...
            if (error) {
              ...
              if (FallbackComponent)
                return React.createElement(FallbackComponent, _extends({}, this.state, {
...
// dep:@bugsnag_plugin-react
var bugsnag_plugin_react_default = require_bugsnag_react();
export {
  bugsnag_plugin_react_default as default
};
