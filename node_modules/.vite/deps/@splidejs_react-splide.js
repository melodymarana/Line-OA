...
var SplideTrack = (_a) => {
  var _b = _a, { children: children2, className } = _b, props = __objRest(_b, ["children", "className"]);
  return import_react2.default.createElement("div", __spreadValues({
    className: classNames("splide__track", className)
  }, props), import_react2.default.createElement("ul", {
...
var Splide2 = class extends import_react.default.Component {
  ...
  render() {
    const _a = this.props, { className, tag: Root = "div", hasTrack = true, children: children2 } = _a, props = __objRest(_a, ["className", "tag", "hasTrack", "children"]);
    return import_react.default.createElement(Root, __spreadValues({
      className: classNames("splide", className),
      ref: this.splideRef
    }, this.omit(props, ["options", ...EVENTS.map((event) => event[1])])), hasTrack ? import_react.default.createElement(SplideTrack, null, children2) : children2);
  }
};
var SplideSlide = (_a) => {
  var _b = _a, { children: children2, className } = _b, props = __objRest(_b, ["children", "className"]);
  return import_react3.default.createElement("li", __spreadValues({
