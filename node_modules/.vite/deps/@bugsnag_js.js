...
var require_bugsnag = __commonJS({
  "node_modules/@bugsnag/browser/dist/bugsnag.js"(exports, module) {
    (function(f) {
      ...
      _$config_5.schema = {
        ...
        endpoints: {
          ...
          validate: function(val) {
            return val && typeof val === "object" && _$stringWithLength_26(val.notify) && _$stringWithLength_26(val.sessions) && _$filter_12(_$keys_15(val), function(k) {
      ...
      ;
      ;
      function add(existingFeatures, name2, variant) {
        ...
        existingFeatures[name2] = variant;
      }
      ...
      function toEventApi(featureFlags) {
        return _$map_16(_$keys_15(featureFlags), function(name2) {
          var flag = {
            featureFlag: name2
          };
          if (typeof featureFlags[name2] === "string") {
            flag.variant = featureFlags[name2];
          }
          return flag;
        });
      }
      ...
      var Event = function() {
        ...
        _proto.addFeatureFlag = function addFeatureFlag(name2, variant) {
          ...
          _$featureFlagDelegate_18.add(this._features, name2, variant);
        };
      ...
      function cuid() {
        var letter = "c", timestamp = new Date().getTime().toString(base), counter = _$pad_29(safeCounter().toString(base), blockSize), print = _$fingerprint_28(), random = randomBlock() + randomBlock();
      ...
      for (var __prop_42 in __env_42) {
        if (Object.hasOwnProperty.call(__env_42, __prop_42))
          __globalCount_42++;
      }
      ...
      function __cuid_41() {
        var letter = "c", timestamp = new Date().getTime().toString(__base_41), counter = _$pad_43(__safeCounter_41().toString(__base_41), __blockSize_41), print = _$fingerprint_42(), random = __randomBlock_41() + __randomBlock_41();
        return letter + timestamp + counter + print + random;
      }
...
// dep:@bugsnag_js
var bugsnag_js_default = require_notifier();
export {
  bugsnag_js_default as default
};
